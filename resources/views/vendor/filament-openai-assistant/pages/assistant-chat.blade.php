    ...
    >
        ...
        >
            <x-filament::input.wrapper>
                <x-filament::input.select wire:model.live="selectedPatientId" searchable="true" wire:change="selectPatient">
            ...
            @error('selectedPatientId') <span style="font-size:15px; color:red">Patient field is required</span> @enderror
        </div>

        <hr style="border:2px dashed #0d9f99"/>
